...
void	W5500_Parameters_Init(void)
{
	W5500_Parameters();
...
void W5500_Parameters(void)
{
	memcpy(ConfigMsg.gw,gateway,4);  //GAR
	memcpy(ConfigMsg.sub,subnet,4);	//SUBR
  memcpy(ConfigMsg.mac, mac, 6);  //SHAR
	memcpy(ConfigMsg.lip,local_ip,4);//SIPR
